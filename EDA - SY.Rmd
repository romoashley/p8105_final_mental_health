...
tidydata |>
  ...
  guides(color = guide_legend(nrow = 2)) +
    ...
    y = "Prevalence",
    title = "Differences in Mental Health Access by Gender (2020-2022)")
```
...
tidydata |>
  ...
  guides(color = guide_legend(nrow = 2)) +
    ...
    x = "Date of data collection",
    y = "Prevalence",
    title = "Differences in Mental Health Access by Sexual Orientation (2021-2022)")
```
...
tidydata |>
  ...
  labs(
    x = "Date of data collection",
    y = "Prevalence",
    title = "Differences in Mental Health Access by Race (2020-2022)")
```