...
I created a data frame where I grouped by states to determine the number of total services, which includes the services received and not received, as well as the number of services not received.
```{r}
states_df =
  received_service |> 
...
Now, I focus on the states of New York. Using the `prop.test` and `broom::tidy` functions, I obtain an estimate and CI of the proportion of mental health services not received in New York (shown in the table below).
