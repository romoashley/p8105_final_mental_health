...
hist(log(Indicator3$value), breaks = "FD", main = "Histogram of Data", xlab = "Data Values")
Indicator4_log=Indicator4 |> mutate(value=log(value))
shapiro_test_result <- shapiro.test(pull(Indicator4_log,value))
```
...
* step 6: Perform Kruskal-Wallis test for Indicator 4 dataset 
